...
const resources = {
  en: {
    translation: {
      ...
      "home": {
        "newbie_badge": "Beginner's Guide",
        "quick_start_title": "5-Minute Quick Start",
        "quick_start_subtitle": "No tech skills needed, follow the steps to save money",
        "step1_title": "Register Account",
        "step1_desc": "Click 'Get Started' on the top right, register with email in 30 seconds",
        "step1_action": "Register Now",
        "step2_title": "Create API Key",
        "step2_desc": "Go to Dashboard, click 'Create New Key', copy the generated Key",
        "step2_action": "View Tutorial",
        "step3_title": "Replace API URL",
        "step3_desc": "Replace https://api.openai.com with https://api.tokesave.com/proxy/openai in your code",
        "step3_action": "View Code",
        "step4_title": "Start Saving",
        "step4_desc": "Check how much Token and cost you saved daily in Dashboard",
        "step4_action": "Go to Dashboard",
        "features_title": "Three Steps to Save 50%",
        "features_subtitle": "No business logic changes needed, as simple as using a CDN",
        "sdk_title": "SDK Mode",
        "sdk_desc": "One line of code to replace LLM Client, auto-compress all requests",
        "proxy_title": "Proxy Mode",
        "proxy_desc": "Modify Base URL, zero code changes, all requests auto-compressed",
        "api_title": "API Mode",
        "api_desc": "Directly call compression API, flexibly integrate into any system",
        "compression_title": "Compression Results",
        "compression_subtitle": "All content types can be significantly compressed",
        ...
        "testimonial1_role": "AI Application Developer",
        "testimonial1_content": "After integrating TokenSaver, our AI customer service costs dropped by 70%. Simple API calls with zero learning curve.",
        "testimonial2_name": "Sarah Wang",
        "testimonial2_role": "Full-stack Engineer",
        "testimonial2_content": "Proxy mode is so convenient. Zero code changes to save half the cost. Dashboard usage stats are very clear.",
        "testimonial3_name": "Mike Zhang",
        "testimonial3_role": "Startup CTO",
        "testimonial3_content": "For startups like us that heavily use LLM, TokenSaver saves thousands of dollars monthly. Excellent ROI.",
        "pricing_simple": "Simple Pricing",
        "pricing_desc": "Savings far exceed product costs",
        "free_plan_name": "Free",
        "pro_plan_name": "Pro",
        "team_plan_name": "Team",
        "free_plan_desc": "For personal developers getting started",
        "pro_plan_desc": "For individual developers and small teams",
        "team_plan_desc": "For teams and enterprises",
        "free_features": ["100 requests/day", "Basic compression", "Community support"],
        "pro_features": ["Unlimited compression", "Advanced algorithms", "API access", "Email support"],
        "team_features": ["5 team members", "Team management", "Usage stats", "Priority support"],
        "cta_start": "Start Using Free",
        "cta_upgrade": "Upgrade Now",
        "cta_contact": "Contact Sales",
        "cta_section_title": "Start Saving on LLM Costs",
        "cta_section_desc": "Join 10,000+ developers using TokenSaver to reduce AI application costs",
  ...
  zh: {
    translation: {
      ...
      "home": {
        "newbie_badge": "新手必看",
        "quick_start_title": "5分钟快速上手",
        "quick_start_subtitle": "不需要懂技术，跟着步骤做，轻松省钱",
        "step1_title": "注册账号",
        "step1_desc": "点击右上角「开始使用」，用邮箱注册，30秒完成",
        "step1_action": "立即注册",
        "step2_title": "创建 API Key",
        "step2_desc": "进入 Dashboard，点击「创建新密钥」，复制生成的 Key",
        "step2_action": "查看教程",
        "step3_title": "替换 API 地址",
        "step3_desc": "把代码里的 https://api.openai.com 换成 https://api.tokesave.com/proxy/openai",
        "step3_action": "查看代码",
        "step4_title": "查看省钱统计",
        "step4_desc": "在 Dashboard 查看每天节省了多少 Token 和费用",
        "step4_action": "进入 Dashboard",
        "features_title": "三步接入，立省一半",
        "features_subtitle": "无需改动业务逻辑，像使用 CDN 一样简单",
        "sdk_title": "SDK 模式",
        "sdk_desc": "一行代码替换 LLM Client，自动压缩所有请求",
        "proxy_title": "Proxy 模式",
        "proxy_desc": "修改 Base URL，零代码改动，所有请求自动压缩",
        "api_title": "API 模式",
        "api_desc": "直接调用压缩 API，灵活集成到任何系统",
        "compression_title": "压缩效果一览",
        "compression_subtitle": "不同内容类型，都能大幅压缩",
        "json_array": "JSON 数组",
        "log_file": "日志文件",
        "search_result": "搜索结果",
        "html_content": "HTML 内容",
        "testimonials_title": "开发者怎么说",
        "testimonials_subtitle": "来自全球开发者的真实反馈",
        "testimonial1_name": "Alex Chen",
        "testimonial1_role": "AI 应用开发者",
        "testimonial1_content": "接入 TokenSaver 后，我们的 AI 客服成本直接降低了 70%。简单的 API 调用，没有任何学习成本。",
        "testimonial2_name": "Sarah Wang",
        "testimonial2_role": "全栈工程师",
        "testimonial2_content": "Proxy 模式太方便了，零代码改动就能节省一半费用。Dashboard 的用量统计也很清晰。",
        "testimonial3_name": "Mike Zhang",
        "testimonial3_role": "创业公司 CTO",
        "testimonial3_content": "对于我们这种大量使用 LLM 的初创公司，TokenSaver 每月帮我们省下几千刀，ROI 极高。",
        "pricing_simple": "简单定价",
        "pricing_desc": "节省的费用远超产品成本",
        "free_plan_name": "免费版",
        "pro_plan_name": "专业版",
        "team_plan_name": "团队版",
        "free_plan_desc": "适合个人开发者体验",
        "pro_plan_desc": "适合个人开发者和小团队",
        "team_plan_desc": "适合团队和企业",
        "free_features": ["100 次/天", "基础压缩", "社区支持"],
        "pro_features": ["无限次压缩", "高级压缩算法", "API 访问", "邮件支持"],
        "team_features": ["5 个成员", "团队管理", "用量统计", "优先支持"],
        "cta_start": "开始使用",
        "cta_upgrade": "立即升级",
        "cta_contact": "联系销售",
        "cta_section_title": "开始节省 LLM 费用",
        "cta_section_desc": "加入 10,000+ 开发者，用 TokenSaver 降低 AI 应用成本",
        "cta_button": "免费开始使用"
      },
      "guide": {
            "title": "5分钟快速上手",
